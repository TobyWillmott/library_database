...
books = [Book(title="The boy in the dress", ISBN_number="9780007329267", num_pages=365, publication_date=2000),
         Book(title="1984", ISBN_number="9780033329467", num_pages=265, publication_date=1948),
         Book(title="Harry Potter and the philosphers stone", ISBN_number="9782207329211", num_pages=165, publication_date=1995),
         Book(title="James and the giant peach", ISBN_number="243908732467", num_pages=144, publication_date=1934),
         ]
